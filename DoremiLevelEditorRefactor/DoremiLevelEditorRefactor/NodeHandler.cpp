			...
			try
			{
				for (std::vector<AttributeDescription>::size_type i = 0; i != m_attributeVector.size(); i++)
				{
					...
					else
					{
						...
						{
							MString myCommand = "addAttr -ln \"" + MString(m_attributeVector[i].name.c_str()) + "\" -at " + MString(m_attributeVector[i].type.c_str()) + " " + p_transform.name();
							MGlobal::executeCommandOnIdle(myCommand);
							myCommand = "addAttr -ln \"" + MString(m_attributeVector[i].name.c_str()) + "X\" -at double -p " + MString(m_attributeVector[i].name.c_str()) + " " + p_transform.name();
							MGlobal::executeCommandOnIdle(myCommand);
							myCommand = "addAttr -ln \"" + MString(m_attributeVector[i].name.c_str()) + "Y\" -at double -p " + MString(m_attributeVector[i].name.c_str()) + " " + p_transform.name();
							MGlobal::executeCommandOnIdle(myCommand);
							myCommand = "addAttr -ln \"" + MString(m_attributeVector[i].name.c_str()) + "Z\" -at double -p " + MString(m_attributeVector[i].name.c_str()) + " " + p_transform.name();
							MGlobal::executeCommandOnIdle(myCommand);
							myCommand = "setAttr -type double3 " + p_transform.name() + "." + m_attributeVector[i].name.c_str() + " " + m_attributeVector[i].value.c_str();
							MGlobal::executeCommandOnIdle(myCommand);
						...
						else if (m_attributeVector[i].type.find("2") != std::string::npos)
						{
							...
							myCommand = "addAttr -ln \"" + MString(m_attributeVector[i].name.c_str()) + "Y\" -at double -p " + MString(m_attributeVector[i].name.c_str()) + " " + p_transform.name();
							MGlobal::executeCommandOnIdle(myCommand);
							myCommand = "setAttr -type double2 " + p_transform.name() + "." + m_attributeVector[i].name.c_str() + " " + m_attributeVector[i].value.c_str();
							MGlobal::executeCommandOnIdle(myCommand);
